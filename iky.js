...
const katalog = (teks) => {
             res = ikyy.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© DEFF_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
┗⬡ `
 ...
 𝔍𝔞??𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰𝔢𝔬𝔯𝔞𝔫𝔤 
  𝔶𝔞𝔫𝔤 𝔪𝔞𝔰??𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 ??𝔞𝔰𝔞𝔩𝔞𝔩??𝔫𝔶𝔞
...
┏━━⬣ PRICE LIST 2
┃⬡ JADI BOT 10K/BLN close
┃⬡ JADI BOT + OWNER 15K close
┃⬡ SC BOT 80K
┃⬡ SC + RECODE 100K
┗━━⬣
┏━━⬣ MINAT? PM
┃⬡ wa.me/62895326097674
┃⬡ Ig deffgns
┃⬡ Yt DEFFBOTZ
┗━━⬣
`
